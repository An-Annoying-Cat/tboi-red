...
---------------------------------------------------
local COLLECTIBLE = enums.collectibles.lil_acacius
local ITEM_CONFIG = Isaac.GetItemConfig():GetCollectible(COLLECTIBLE)
local FAMILIAR = enums.familiars.lil_acacius
local TEAR_VARIANT = TearVariant.SWORD_BEAM
local TEAR_FLAGS = TearFlags.TEAR_LIGHT_FROM_HEAVEN | TearFlags.TEAR_MIDAS
local BFFS_FLAGS = {[true] = TearFlags.TEAR_LASER, [false] = TearFlags.TEAR_NORMAL} --true if BFFs
